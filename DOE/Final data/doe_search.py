# adapted from a script by Christine Eslao
...
with codecs.open('DOE_results_for_search.csv', mode='rU', encoding='ascii', errors='ignore') as f:
...
#with open('/Users/christine/adsgrants/nasa/NASA_grants_2006-2012_NNX13AB84G.csv', 'rU') as f:
    ...
    f2 = open('DOE_grants_output_single_query.csv', 'wb')
